...
public class SliderAdapter extends SliderViewAdapter<SliderAdapter.SliderAdapterVH> {
    ...
    private List<SliderClass> mSliderItems = new ArrayList<>();

    // constructor for our adapter class.
    public SliderAdapter(Context context, List<SliderClass> mSliderItems) {
    ...
    public SliderAdapterVH onCreateViewHolder(ViewGroup parent) {
        ...
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.slider_one, null);
    ...
    public void onBindViewHolder(SliderAdapterVH viewHolder, int position) {
        ...
        final SliderClass sliderItem = mSliderItems.get(position);
